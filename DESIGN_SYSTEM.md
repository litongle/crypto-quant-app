# 币钱袋 (CryptoQuant) — 统一设计系统 v3.1

> 基于专业金融交易产品标准，构建跨平台一致的视觉语言
>
> **设计参考**：视觉风格借鉴 [Stripe](https://stripe.com)（专业金融 + 克制奢华），但在色彩体系上从 Stripe 紫（#7c83f7）调整为 Indigo（#6366F1），更适合暗色交易界面长时间盯盘。字体从 Inter 升级为 Geist Sans（消除 AI Slop 气质），圆角从 4-8px 放宽到 6-10px。
...
*v3.1 · 2026-04-26 · 流体缩放升级 + 规则构建器 + Geist Sans 字体*
