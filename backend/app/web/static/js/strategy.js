  ...
  return `
    <div class="cq-card cq-instance-card">
      ...
      <div class="cq-instance-card__actions">
        ...
        <button class="cq-btn cq-btn--secondary cq-btn--sm" data-instance-id="${instance.id}" data-instance-name="${escapeHtml(instance.name || `实例 #${instance.id}`)}" onclick="openInstanceLogsDrawerFromBtn(this)">
