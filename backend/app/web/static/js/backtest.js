    ...
    <div class="cq-card cq-metrics-detail" style="margin-bottom:var(--cq-space-4);">
      ...
      <div class="cq-metrics-detail__body">
        <div class="cq-metrics-detail__grid">
          ...
          <div class="cq-metrics-detail__item" title="盈利交易笔数 / 亏损交易笔数"><span class="cq-metrics-detail__label">盈利 / 亏损次数</span><span class="cq-metrics-detail__value cq-num"><span style="color:${profitTrades > 0 ? 'var(--cq-color-profit)' : 'var(--cq-text-tertiary)'};">${profitTrades}</span> / <span style="color:${lossTrades > 0 ? 'var(--cq-color-loss)' : 'var(--cq-text-tertiary)'};">${lossTrades}</span></span></div>
          ...
          <div class="cq-metrics-detail__item" title="连续盈利 / 连续亏损的最长记录条数。从 trades 顺序推导"><span class="cq-metrics-detail__label">最大连胜 / 连亏</span><span class="cq-metrics-detail__value cq-num"><span style="color:${maxConWins > 0 ? 'var(--cq-color-profit)' : 'var(--cq-text-tertiary)'};">${maxConWins}</span> / <span style="color:${maxConLosses > 0 ? 'var(--cq-color-loss)' : 'var(--cq-text-tertiary)'};">${maxConLosses}</span></span></div>
