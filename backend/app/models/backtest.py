...
class BacktestResult(Base):
    ...
    total_return: Mapped[Decimal] = mapped_column(
        Numeric(20, 8), default=Decimal("0"), comment="总收益"
    )
    total_return_pct: Mapped[Decimal] = mapped_column(
        Numeric(10, 4), default=Decimal("0"), comment="总收益率%"
    )
    annual_return: Mapped[Decimal] = mapped_column(
        Numeric(10, 4), default=Decimal("0"), comment="年化收益率%"
    )
    sharpe_ratio: Mapped[Decimal] = mapped_column(
        Numeric(10, 4), default=Decimal("0"), comment="夏普比率"
    )
    calmar_ratio: Mapped[Decimal] = mapped_column(
        Numeric(10, 4), default=Decimal("0"), comment="卡玛比率"
    )
    max_drawdown: Mapped[Decimal] = mapped_column(
        Numeric(10, 4), default=Decimal("0"), comment="最大回撤%"
    )
    win_rate: Mapped[Decimal] = mapped_column(Numeric(5, 2), default=Decimal("0"), comment="胜率%")
    profit_factor: Mapped[Decimal] = mapped_column(
        Numeric(10, 4), default=Decimal("0"), comment="盈亏比"
    )
    ...
    avg_profit: Mapped[Decimal] = mapped_column(
        Numeric(20, 8), default=Decimal("0"), comment="平均盈利"
    )
    avg_loss: Mapped[Decimal] = mapped_column(
        Numeric(20, 8), default=Decimal("0"), comment="平均亏损"
    )
    ...
    end_time: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True, comment="回测结束时间"
    )
